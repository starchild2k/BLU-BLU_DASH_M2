...
$(call inherit-product-if-exists, vendor/BLU/BLU_DASH_M2/BLU_DASH_M2-vendor.mk)

LOCAL_PATH := device/BLU/BLU_DASH_M2
...
PRODUCT_NAME := full_BLU_DASH_M2
PRODUCT_DEVICE := BLU_DASH_M2
