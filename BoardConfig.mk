...
# Bootloader
TARGET_BOOTLOADER_BOARD_NAME := BLU_DASH_M2
...
BOARD_USERDATAIMAGE_PARTITION_SIZE := 1501036544
...
BOARD_MKBOOTIMG_ARGS := --base 80000000 --pagesize 2048 --kernel_offset 00008000 --ramdisk_offset 04000000 --tags_offset 0e000000   --cmdline 'bootopt=64S3,32S1,32S1' --board BLU_D090U_V17_G 
...
TARGET_RECOVERY_FSTAB := device/BLU/BLU_DASH_M2/recovery/root/etc/recovery.fstab
